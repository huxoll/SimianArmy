...
/** The basic implementation of the email notifier for Sniper monkey.
 *
 */
public class BasicSniperEmailNotifier extends SniperEmailNotifier {

    /** The Constant LOGGER. */
    private static final Logger LOGGER = LoggerFactory.getLogger(BasicSniperEmailNotifier.class);
     ...
     */
    public BasicSniperEmailNotifier(MonkeyConfiguration cfg, AmazonSimpleEmailServiceClient sesClient,
    ...
    public void sendTerminationGlobalNotification(InstanceGroup group, String instanceId) {
        String to = cfg.getStr("simianarmy.sniper.notification.global.receiverEmail");
    ...
    protected String getOwnerEmail(InstanceGroup group) {
        String prop = String.format("simianarmy.sniper.%s.%s.ownerEmail", group.type(), group.name());
    ...
    public void buildAndSendEmail(String to, InstanceGroup group, String instanceId) {
        ...
        boolean emailSubjectIsBody = cfg.getBoolOrElse(
                "simianarmy.sniper.notification.subject.isBody", false);
    ...
    public String buildEmailSubject(String to) {
        String emailSubjectPrefix = cfg.getStrOrElse("simianarmy.sniper.notification.subject.prefix", "");
        String emailSubjectSuffix = cfg.getStrOrElse("simianarmy.sniper.notification.subject.suffix", "");
        return String.format("%sSniper Monkey Termination Notification for %s%s",
    ...
    public String buildEmailBody(InstanceGroup group, String instanceId) {
        String emailBodyPrefix = cfg.getStrOrElse("simianarmy.sniper.notification.body.prefix", "");
        String emailBodySuffix = cfg.getStrOrElse("simianarmy.sniper.notification.body.suffix", "");
        String body = String.format("%sInstance %s of %s %s is being terminated by Sniper monkey.%s",
    ...
    public String getSourceAddress(String to) {
        String prop = "simianarmy.sniper.notification.sourceEmail";
