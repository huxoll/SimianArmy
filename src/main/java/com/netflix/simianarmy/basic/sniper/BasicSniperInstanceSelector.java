...
/**
 * The Class BasicSniperInstanceSelector.
 */
public class BasicSniperInstanceSelector implements SniperInstanceSelector {

    /** The Constant LOGGER. */
    private static final Logger LOGGER = LoggerFactory.getLogger(BasicSniperInstanceSelector.class);
