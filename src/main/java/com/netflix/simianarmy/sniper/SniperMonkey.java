 ...
 *
 */
package com.netflix.simianarmy.sniper;
...
/**
 * The Class SniperMonkey.
 */
public abstract class SniperMonkey extends Monkey {
    ...
    public interface Context extends Monkey.Context {
         ...
         * Sniper crawler.
         *
         * @return the sniper crawler
         */
        SniperCrawler sniperCrawler();

        /**
         * Sniper instance selector.
         *
         * @return the sniper instance selector
         */
        SniperInstanceSelector sniperInstanceSelector();

        /**
         * Sniper email notifier.
         *
         * @return the sniper email notifier
         */
        SniperEmailNotifier sniperEmailNotifier();
    }
    ...
    /**
     * Instantiates a new sniper monkey.
     *
     * @param ctx
     *            the context.
     */
    public SniperMonkey(Context ctx) {
        super(ctx);
        this.ctx = ctx;
    }
    ...
    public enum EventTypes {
        ...
        /** The sniper termination. */
        SNIPER_TERMINATION, SNIPER_TERMINATION_SKIPPED
    }
    ...
    /**
     * Gets the count of terminations since a specific time. Sniper should probably not continue to beat up an instance
    ...
    /**
     * Record termination. This is used to notify system owners of terminations and to record terminations so that Sniper
     ...
     *            the instance
     */
    public abstract void sendTerminationNotification(SniperCrawler.InstanceGroup group, String instance);
}
