...
/**
 * The Interface SniperInstanceSelector.
 */
public interface SniperInstanceSelector {

    /**
     * Select. Pick random instances out of the group with provided probability. Sniper will draw a random number and if
     ...
     *
     * The probability is the run probability. If Sniper is running hourly between 9am and 3pm with an overall configured
     * probability of "1.0" then the probability provided to this routine would be 1.0/6 (6 hours in 9am-3pm). So the
     * typical probability here would be .1666. For Sniper to select an instance it will pick a random number between 0
     ...
     * certain.
     *
     * To make Sniper select an instance with 100% certainty it would have to be configured to run only once a day and
