...
/** The email notifier for Sniper monkey.
 *
 */
public abstract class SniperEmailNotifier extends AWSEmailNotifier {
     ...
     */
    public SniperEmailNotifier(AmazonSimpleEmailServiceClient sesClient) {
        super(sesClient);
    }
