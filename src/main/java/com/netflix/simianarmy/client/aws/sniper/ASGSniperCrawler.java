 ...
 *
 */
package com.netflix.simianarmy.client.aws.sniper;
...
import com.netflix.simianarmy.basic.sniper.BasicInstanceGroup;
import com.netflix.simianarmy.sniper.SniperCrawler;
import com.netflix.simianarmy.client.aws.AWSClient;

/**
 * The Class ASGSniperCrawler. This will crawl for all available AutoScalingGroups associated with the AWS account.
 */
public class ASGSniperCrawler implements SniperCrawler {
    ...
    /**
     * Instantiates a new basic sniper crawler.
     *
     * @param awsClient
     *            the aws client
     */
    public ASGSniperCrawler(AWSClient awsClient) {
